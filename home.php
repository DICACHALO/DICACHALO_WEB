...
<h6 class="media-heading">
        ...
        <div id="content">     
            <div class="inner" style="min-height: 700px;">
                ...
                <p class="text-muted text-center btn-block btn btn-primary btn-rect">Ingrese el nombre de su nuevo diccionario</p><br/>
                <input type="text" required="required" name="diccionario" placeholder="Nombre del diccionario"  class="form-control" />
                <br/>
                <button class="btn text-muted text-center btn-success" name="guardar1" type="submit">ENVIAR</button>
                ...
                if (isset($_POST['guardar1'])){
                      ...
                      $id_usuario=$_SESSION['id_usuario'];          
                        //Consulta
                      $consulta ="INSERT INTO tab_diccionario (nom_diccionario,id_usuario) VALUES ('$diccionario','$id_usuario');";
                      ...
                      ?>
                        ...
                        <div id="diccionario" class="tab-pane">
                <form action="" method="POST" class="form-signin">
                <p class="text-muted text-center btn-block btn btn-primary btn-rect">Añada conceptos</p><br/>
                <?php 
                @session_start();
                include("conectar.php");
                $id_usuario=$_SESSION['id_usuario'];
                ...
                {echo "<select required name='id_diccionario' id='id_diccionario' class='form-control'>
                                <option selected='selected' value=''>Seleccione el diccionario </option>";
                                ...
                                ?>
                <br/>
                <input type="text" required="required" name="concepto" placeholder="Concepto"  class="form-control" />
                <br/>
                <input type="<text>" required="required" name="significado" placeholder="Significado"  class="form-control" />
                <br/>
                <button class="btn text-muted text-center btn-success" name="guardar2" type="submit">ENVIAR</button>
                <?php
                include("conectar.php");
                if (isset($_POST['guardar2'])){
                      ...
                      $significado=$_POST['significado'];          
                        //Consulta
                      $consulta1 ="INSERT INTO tab_concepto (concepto,id_diccionario) VALUES ('$concepto','$id_diccionario');";
                      $respuesta1= pg_query($consulta1) or die ('Error. Intente de nuevo'.pg_last_error($dbconn));
                      $consulta2 ="INSERT INTO tab_significado (significado,id_diccionario) VALUES ('$significado','$id_diccionario');";
                      $respuesta2= pg_query($consulta2) or die ('Error. Intente de nuevo'.pg_last_error($dbconn));
                      } 
                      pg_close($dbconn);
                      ?>
                </form>
        ...
        <div id="right">
            ...
            <form action="zona_juegos.php">
                <button type="submit" name="config"class="btn btn-info btn-block">JUEGOS</button>
                </form>
                <br>
